...
void  plotly::my_dtostrf (double value, signed char whole, unsigned char part, char* inbuffer) {
  char formatter[20];
  sprintf(formatter, "%%%d.%df", whole, part);
  sprintf(inbuffer, formatter, value);
}
